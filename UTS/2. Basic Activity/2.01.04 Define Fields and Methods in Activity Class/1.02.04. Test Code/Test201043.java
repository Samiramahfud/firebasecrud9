...
public class Test201043 extends ViewTest {
   private MyActivity layout;

   @Before
   public void startTest() {
       layout = new MyActivity();
   }
   ...
   public void check_01_Fields_Availability() { //Check Layout Specification
    ...
    public void check_04_strResult() {
        ...
        testItem(layout.strResult(value,false), String.valueOf(value),"Test of double to string conversion is failed!!",1);
    }
}
